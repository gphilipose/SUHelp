...
$sql = "SELECT ACTOR_FNAME, ACTOR_LNAME, ROLE_NAME, ROLE_DESCRIPTION 
FROM ASSOCIATION NATURAL JOIN ACTOR WHERE ACTOR_ID IN 
(SELECT ACTOR_ID FROM ACTOR WHERE ACTOR_FNAME LIKE 'Robert')";
