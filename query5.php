...
// (3.1): Matches user's name with their reviews
$sql = "SELECT MOVIE.MOVIE_TITLE, MOVIE.MOVIE_RELEASE_DATE, DIRECTOR.DIRECTOR_FNAME, DIRECTOR.DIRECTOR_LNAME
FROM MOVIE LEFT JOIN DIRECTOR ON MOVIE.DIRECTOR_ID = DIRECTOR.DIRECTOR_ID";
